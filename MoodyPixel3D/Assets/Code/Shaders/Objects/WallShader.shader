Shader "Long Hat House/WallShader"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            //fixed3 dist = IN.viewDir;
            //fixed2 projectedBaseDist = project2d(distToPlayer, IN.viewDir.xz);
            //float camDist = length(projectedDist);//length(project2d((IN.worldPos.xz - PlayerPosition.xz, IN.viewDir.xz));
            //c.rgb += dist;
            o.Albedo = c.rgb;
            ...
            //Clip part
            //clip(dot(IN.worldNormal, IN.viewDir));
